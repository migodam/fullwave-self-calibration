...
> 2026-09-06 后续研究入口：[A2 主审查与修订](../research/trispace_self_calibration/a2_research/FINAL_REVIEW.md)、[最新论文初稿](../research/trispace_self_calibration/a2_research/PAPER_DRAFT_A2.md)、[中文科研汇报](../communication/A2_RESEARCH_REPORT_ZH.md)。本文件保留原讨论历史；特别注意新版本严格区分自由电流维数与数值状态维数，实验支持与未通过门槛以 A2 主审查为准。
